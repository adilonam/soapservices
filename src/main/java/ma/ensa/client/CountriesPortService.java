 ...
 * 
 */
@WebServiceClient(name = "CountriesPortService", targetNamespace = "http://www.ensa.ma/MySoapService", wsdlLocation = "http://localhost:8080/ws/countries.wsdl")
    ...
    extends Service
{
    ...
    private final static QName COUNTRIESPORTSERVICE_QNAME = new QName("http://www.ensa.ma/MySoapService", "CountriesPortService");
    ...
    public CountriesPort getCountriesPortSoap11() {
        return super.getPort(new QName("http://www.ensa.ma/MySoapService", "CountriesPortSoap11"), CountriesPort.class);
    }
    ...
    public CountriesPort getCountriesPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.ensa.ma/MySoapService", "CountriesPortSoap11"), CountriesPort.class, features);
    }
